#' Datos de Gapminder.
#' 
#' Extracto de la base de datos de Gapminder con registros de expectativa de vida,
#' PBI per capita y población por país.
#' 
#' @format El data frame \code{gapminder} contiene 1704 filas y 6 variables:
#' \describe{ 
