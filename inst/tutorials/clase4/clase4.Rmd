...
Recurriendo a `scale_color_manual()` como hicimos en una lección anterior, aquí queda el ejercicio resuelto:
...
En esta ocasion no usamos la capa de radios, como si habíamos visualizado en el ejemplo con `ggplot`. ¿Porqué creen que fue? ¿Cómo mostrarían la capa de radios?
