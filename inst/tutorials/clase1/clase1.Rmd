...
Para seguir practicando, un excelente recurso es libro *Data Visualization - A practical introduction* por Kieran Healy. Se puede consultar en línea, y tenemos el capítulo dedicado a los fundamentos de `ggplot` aquí: ["Make a plot":](https://socviz.co/makeplot.html)
