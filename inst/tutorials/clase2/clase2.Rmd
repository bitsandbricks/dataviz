...
Ahora iremos más allá del aspecto que tienen los gráficos de ggplot _por defecto_, puliéndolos para para su publicación.
...
En el video de la BBC, la visualización se presenta sin leyendas para reducir al mínimo el texto en pantalla, y que se pueda mirar como casi un cuadro. Para eliminar leyendas en nuestro ggplot, podemos usar `guides`, y dentro asignar el valor `FALSE` a cada atributo estético para el cual no queremos leyenda - por ejemplo, `color = FALSE`. ¿Cómo eliminamos la leyenda de los atributos color y tamaño?
...
Y con eso, terminamos por ahora. Para seguir practicando, en *Data Visualization - A practical introduction* de Kieran Healy tenemos el caítulo: ["Refine your plots":](https://socviz.co/refineplots.html)